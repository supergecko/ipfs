<template>
	<view class="reset">
		<input class="ipt" type="text" placeholder="请输入手机号" v-model="userPhone"/>
		<view class="yzm">
		...
		<text class="btn" @click="_resetPassword">重置密码</text>
		<text class="btn" @click="toPage()" style="margin-top: 20px;">账号密码登录</text>
	</view>
</template>
