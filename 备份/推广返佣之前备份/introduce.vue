<template>
	<view class="introduceWarp">
		...
		<view class="introduceContent1">
			<view class="introduceTitle">推广返佣</view>
			...
			<view class="currencyText" style="margin-top: 32upx;">
				<view class="currencyTitle">代理佣金</view>
				<view style="width: 614upx;height: 128upx;margin: 0 auto;">
					<view>市级代理:以下2条件任意满足一条即可(给予管理5%分红)</view>
					<view style="padding-left: 12px;">①要求：自购1000T存储空间<span style="color:#FE3E30;"></span></view>
					<view style="padding-left: 12px;">②要求：销售额度累计达到3000T存储空间<span style="color:#FE3E30;"></span></view>
					<view style="padding-left: 12px;"><span style="color:#FE3E30;"></span></view>
				</view>
				<view style="width: 614upx;height: 128upx;margin: 0 auto;margin-top: 32upx;">
					<view>县级代理:以下2条件任意满足一条即可(给予管理3%分红)</view>
					<view style="padding-left: 12px;">①要求：自购300T存储空间<span style="color:#FE3E30;"></span></view>
					<view style="padding-left: 12px;">②要求：销售额度累计达到1000T存储空间<span style="color:#FE3E30;"></span></view>
				</view>
				<view style="width: 614upx;height: 128upx;margin: 0 auto;margin-top: 32upx;">
					<view>区域销售</view>
					<view style="padding-left: 12px;">①要求：自购100T存储空间<span style="color:#FE3E30;"></span></view>
				</view>
				<view style="width: 614upx;height: 128upx;margin: 0 auto;margin-top: 32upx;">
					<view>销售员</view>
					<view style="padding-left: 12px;">①要求：自购10T存储空间<span style="color:#FE3E30;"></span></view>
				</view>
			</view>
		</view>
